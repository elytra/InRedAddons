package com.elytradev.inredaddons.block.entity;
...
public class ColorLEDBlockEntity extends IRComponentBlockEntity implements Tickable, MultimeterProbeProvider, InfraRedstoneCapable, EncoderScannable {
	...
	public StringTextComponent getProbeMessage() {
		TranslatableTextComponent message = new TranslatableTextComponent("msg.inredadd.multimeter.rgbled");
